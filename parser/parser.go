...
func New(l *lexer.Lexer) *Parser {
	...
	p.bootstrapPrefixPratt()
	p.bootstrapInfixPratt()
...
func (p *Parser) bootstrapPrefixPratt() {
...
func (p *Parser) parseFunctionBlock() ast.Expression {
	lit := &ast.FunctionBlock{Token: p.curToken}
